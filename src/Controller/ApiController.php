...
class ApiController extends AbstractController
{
     ...
     */
    public function majEvent(Tournois $calendar, Request $request)
    {
        ...
        if(
           ...
           // $calendar->setNom($data->title);
            $calendar->setDescriptiontournois($data->description);
            $calendar->setDateDebut(new DateTime($data->start));
            $calendar->setDateFin(new DateTime($data->end));


            // if($donnees->allDay){
          // $calendar->setDateR(new DateTime($data->end));
            // }else{
